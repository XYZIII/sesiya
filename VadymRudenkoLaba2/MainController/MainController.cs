        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                switch (n)
                {
                    case 1:
                        #region 1-е Задание
                        Adress MyAdress = new Adress(93105, "Ukraine", "Kiev", "Zdanova", 35, 25);
                        MyAdress.ShowInfo();
                        #endregion
                        break;
                    case 2:
                    ...
                    case 5:
                        #region 5-е Задание
                        User MyUser = new User("User1234", "Vadym", "Rudenko", 18, "18.03.2020");
                        MyUser.ShowInfo();
                        #endregion
                        break;
                    case 6:
                    ...
                    case 8:
                        #region 8-е Задание
                        Invoice invoice = new Invoice(16847, "Vadym", "IBM");
                        invoice.Price();
                        #endregion
                        break;
                    default:
